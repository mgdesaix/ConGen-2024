...
Using the balanced western IDs file we created above, we can then subset the full Beagle file. The code below cuts the first column from the `*.wgsassign.ids.txt` to input the individuals we want to the script, followed by providing the Beagle file (and de-compressing it)
